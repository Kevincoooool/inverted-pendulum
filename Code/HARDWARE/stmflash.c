...
void Flash_Read(void)
{
	...
	if(PID_Parameter[0]==65535&&PID_Parameter[1]==65535&&PID_Parameter[2]==65535&&PID_Parameter[3]==65535)   //Flash被清零之后，使用默认参数
	{
//		Balance_KP=40;   //默认参数
//		Balance_KD=200;
//		Position_KP=20;
//		Position_KD=400;
	...
	{		
//		Balance_KP=(float)PID_Parameter[0]/100;  //读取掉电保存的参数
//		Balance_KD=(float)PID_Parameter[1]/100;
//		Position_KP=(float)PID_Parameter[2]/100;
//		Position_KD=(float)PID_Parameter[3]/100;
	}
}	

void Flash_Write(void)
{
//		Flash_Parameter[0]=Balance_KP*100;		   //向Flash里面写参数
//		Flash_Parameter[1]=Balance_KD*100;	
//		Flash_Parameter[2]=Position_KP*100;	
//		Flash_Parameter[3]=Position_KD*100;	
